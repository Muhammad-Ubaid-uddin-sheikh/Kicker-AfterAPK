...
import { View, Text, StyleSheet, StatusBar, TextInput, TouchableOpacity, Alert, ScrollView, Image, Modal, PermissionsAndroid } from 'react-native';
  ...
  console.log("pinCoordinate",pinCoordinate?.latitude)
    ...
    const reverseGeocode = async (latitude, longitude) => {
        try {
          ...
          // Extract short names of the filtered components and join them with commas
    ...
    return (
        ...
        >
          {mapReady && pinCoordinate && (
            <Marker coordinate={pinCoordinate} title='Selected Location' pinColor='green' draggable
              onDragEnd={(e) => {
        ...
        {/* {pinCoordinate && (
          <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            <Text>Latitude: {pinCoordinate.latitude}</Text>
            <Text>Longitude: {pinCoordinate.longitude}</Text>
