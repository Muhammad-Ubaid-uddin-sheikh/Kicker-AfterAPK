...
import { Text, View,FlatList, Modal, StyleSheet, TouchableOpacity  } from 'react-native'
...
const ShaduleRevisa = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const token = await AsyncStorage.getItem('accessToken'); // Replace with your actual access token
...
const renderItem = ({ item }) => (
  <TouchableOpacity onPress={() => setSelectedItem(item)}>
      ...
      <View style={styles.itemContainer}>
        ...
        <Text style={styles.itemPay}>{item?.paymentStatus || 'N/A'}</Text>
        </View>
      </View>
  </TouchableOpacity>
);
...
const closeModal = () => setSelectedItem(null);
  ...
  return (
    <View style={[styles.inputContainer, { paddingTop: 0 ,marginTop:0}]}>
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                      ...
                      <View style={[styles.DisplayFlexProp,{width:"100%",paddingTop:30,borderBottomColor:'rgba(33, 33, 33, 0.25)',borderBottomWidth:0.5,paddingBottom:5}]}>
                        <View>
                        <Text style={[styles.itemGround,{color:'#21212199',fontFamily:Fonts.MEDIUM}]}>Tiempo</Text>
                        </View>
                        <View>
                      ...
                      <View style={[styles.DisplayFlexProp,{width:"100%",paddingTop:10,borderBottomColor:'rgba(33, 33, 33, 0.25)',borderBottomWidth:0.5,paddingBottom:5}]}>
                        ...
                        <View>
                        <Text style={styles.modalTitle}>{selectedItem?.paymentStatus}</Text>
                        </View>                   
                      </View>
