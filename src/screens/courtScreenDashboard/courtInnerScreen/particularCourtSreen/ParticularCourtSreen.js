...
const navigation = useNavigation();
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={{ uri: item.images.length > 0 ? item.images[0] : 'https://your-default-image-url.com' }}
      ...
      <View style={styles.locationTextContainer}>
        ...
        <Text numberOfLines={1} ellipsizeMode="tail" style={[styles.textLocation,{width:'70%'}]}> {item.location} </Text>
